//! Captura de tela via xcap 0.4 (Windows/X11; Wayland via portal dbus). As
//! capturas caem em `app_data/captures` e abrem direto no anotador. Região =
//! capturar a tela e recortar no editor (robusto em qualquer plataforma —
//! sem overlay nativo).
...
fn capture_name() -> String {
    // Sem chrono de propósito (dependência a menos): epoch-ms é único e ordena.
